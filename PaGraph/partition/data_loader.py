...
class DataLoader:
    ...
    def __init__(self, data):
        self.cfg = {
            'movie': {
                'item2id_path': 'PaGraph/data/data_pagraph/data/movie/item_index2entity_id.txt',
                'kg_path': 'PaGraph/data/data_pagraph/data/movie/kg.txt',
                'rating_path': 'PaGraph/data/data_pagraph/data/movie/ratings.csv',
                'rating_sep': ',',
                'threshold': 4.0
            },
            'music': {
                'item2id_path': 'PaGraph/data/data_pagraph/data/music/item_index2entity_id.txt',
                'kg_path': 'PaGraph/data/data_pagraph/data/music/kg.txt',
                'rating_path': 'PaGraph/data/data_pagraph/data/music/user_artists.dat',
                'rating_sep': '\t',
                'threshold': 0.0
            }
        }
        ...
        self.user_encoder = LabelEncoder()   # Encode target labels with value between 0 and n_classes-1.
    ...
    def _encoding(self):
        ...
        # print(self.user_encoder.classes_)
